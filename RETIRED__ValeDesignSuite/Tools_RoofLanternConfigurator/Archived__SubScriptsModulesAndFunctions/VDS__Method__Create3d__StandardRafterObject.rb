...
module ValeDesignSuite
    module Create3dStandardRafterObject
        ...
        # JSON profile paths
        PRIMARY_JSON  = 'D:\02_CoreLib__SketchUp\01_CoreLib__Components\60-Series__ProfilesLibrary__ValeProfilesLib\PFL001__RoofLantern__TypicalRafters__GlazeBarCapsAndMouldings__SketchUpToJsonData__.json'.freeze
