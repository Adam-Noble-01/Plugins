...
# - Na__DevTools__JsonExporter2D__
# - Na__DevTools__JsonExporter3D__
#
# NAMING CONVENTION:
...
# -----------------------------------------------------------------------------
    ...
    NA_EXPORTER_2D_FILE         = "Na__DevTools__JsonExporter2D__".freeze
    NA_EXPORTER_3D_FILE         = "Na__DevTools__JsonExporter3D__".freeze
    # ---------------------------------------------------------------
