# =============================================================================
# NA INTERIOR DOOR CONFIGURATOR - GEOMETRY ENGINE
# =============================================================================
#
# FILE       : Na__InteriorDoorConfigurator__GeometryEngine__.rb
...
#
# DESCRIPTION:
# - High-level orchestration mirroring Na__WindowConfiguratorTool::Na__GeometryEngine.
# - Public surface:
...
# -----------------------------------------------------------------------------
        ...
        GeometryBuilders    = Na__InteriorDoorConfigurator::Na__GeometryBuilders
        ArchitraveBuilder   = Na__InteriorDoorConfigurator::Na__ArchitraveBuilder
        HandleBuilder3D     = Na__InteriorDoorConfigurator::Na__HandleBuilder3D
        FuseLiningParts     = Na__InteriorDoorConfigurator::Na__FuseLiningParts
        DoorAssemblyComposer= Na__InteriorDoorConfigurator::Na__DoorAssemblyComposer
...
# -----------------------------------------------------------------------------
        ...
        # Na__WindowConfiguratorTool::Na__MaterialManager (which already
        ...
        # HELPER FUNCTION | Look Up the Window Configurator's MaterialManager Module
        # ------------------------------------------------------------
        ...
        def self.na_material_manager
            return nil unless defined?(Na__WindowConfiguratorTool::Na__MaterialManager)
            Na__WindowConfiguratorTool::Na__MaterialManager
        end
