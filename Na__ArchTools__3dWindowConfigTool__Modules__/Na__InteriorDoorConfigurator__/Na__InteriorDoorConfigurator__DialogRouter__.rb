# =============================================================================
# NA INTERIOR DOOR CONFIGURATOR - DIALOG ROUTER
# =============================================================================
#
# FILE       : Na__InteriorDoorConfigurator__DialogRouter__.rb
...
#
# DESCRIPTION:
# - Mirrors the responsibility split used by the WindowConfiguratorTool's
#   DialogManager but only for door-tab actions. The shared dialog
#   instance still lives in WindowConfiguratorTool::Na__DialogManager;
...
require_relative File.join(                                                    # <-- Shared three-point measurement tool now lives one folder up
    "..",
...
# -----------------------------------------------------------------------------
        ...
        DataSerializer = Na__InteriorDoorConfigurator::Na__DataSerializer
        GeometryEngine = Na__InteriorDoorConfigurator::Na__GeometryEngine
...
# Na__WindowConfiguratorTool::Na__DialogManager. The router previously
...
# -----------------------------------------------------------------------------
        ...
        def self.na_active_dialog
            return nil unless defined?(::Na__WindowConfiguratorTool::Na__DialogManager)
            mgr = ::Na__WindowConfiguratorTool::Na__DialogManager
...
# -----------------------------------------------------------------------------
        ...
        # ------------------------------------------------------------
        # Called from Na__InteriorDoorConfigurator.na_init_door_callbacks
        # after the WindowConfiguratorTool's DialogManager has built the
        # shared HtmlDialog.
        #
...
# -----------------------------------------------------------------------------
        ...
        def self.na_handle_measure_door_opening
            ...
            tool = ::Na__MeasurementTools::Na__ThreePointOpeningTool.new(self)
...
# -----------------------------------------------------------------------------
        ...
        # ------------------------------------------------------------
        # Used by Na__InteriorDoorConfigurator.na_load_door_into_dialog
