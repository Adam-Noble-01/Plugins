...
unless file_loaded?(__FILE__)
    ...
    # ------------------------------------------------------------
    plugin_root = File.dirname(__FILE__)                           # <-- Get current script directory (Plugins folder)
    na_dependencies = File.join(plugin_root, 'Na_Dependencies')    # <-- Path to Na_Dependencies folder (sibling folder)
