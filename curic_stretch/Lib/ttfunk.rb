...
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/directory'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/resource_file'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/collection'))

module TTFunk
  PATH_ROOT = ::File.join(::File.dirname(__FILE__).freeze, 'ttfunk')
...
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/cmap'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/glyf'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/head'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/hhea'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/hmtx'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/kern'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/loca'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/maxp'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/name'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/os2'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/post'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'ttfunk/table/sbix'))