...
module TTFunk
  Sketchup.require(::File.join(PATH_ROOT, 'table/cmap'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/glyf'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/head'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/hhea'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/hmtx'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/kern'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/loca'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/maxp'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/name'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/post'))
  Sketchup.require(::File.join(PATH_ROOT, 'table/simple'))
