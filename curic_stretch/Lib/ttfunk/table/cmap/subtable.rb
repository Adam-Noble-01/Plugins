...
module TTFunk
  Sketchup.require(::File.join(PATH_ROOT, 'reader'))
...
Sketchup.require(::File.join(::File.dirname(__FILE__), 'format00'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'format04'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'format06'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'format10'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'format12'))
