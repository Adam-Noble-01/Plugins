...
Sketchup.require(::File.join(::File.dirname(__FILE__), 'post/format10'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'post/format20'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'post/format30'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'post/format40'))