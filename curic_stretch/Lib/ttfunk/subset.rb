...
Sketchup.require(::File.join(::File.dirname(__FILE__), 'subset/unicode'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'subset/unicode_8bit'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'subset/mac_roman'))
Sketchup.require(::File.join(::File.dirname(__FILE__), 'subset/windows_1252'))
