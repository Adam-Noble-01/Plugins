# =============================================================================
# NA PROFILE TOOLS - GEOMETRY HELPERS - PATH ANALYSIS
# =============================================================================
#
# FILE       : Na__ProfileTools__GeometryHelpers__PathAnalysis__.rb
# NAMESPACE  : Na__ProfileTools__ProfilePathTracer::Na__PathAnalysis
...
module Na__ProfileTools__ProfilePathTracer
    ...
    # -------------------------------------------------------------------------
        ...
        def self.Na__Path__NormaliseClosedLoopWinding(ordered_points, ordered_edges)
            ...
            return { ordered_points: ordered_points, ordered_edges: ordered_edges } if signed_area <= 0    # <-- Force CW traversal
        ...
        def self.Na__Path__ReverseClosedLoopPoints(ordered_points)
            ...
            return points.reverse if points.first != points.last
            head = points[0...-1].reverse
            head + [head.first]
        end
    ...
    # -------------------------------------------------------------------------
    # REGION | Path Reordering From User Pick
    # -------------------------------------------------------------------------
