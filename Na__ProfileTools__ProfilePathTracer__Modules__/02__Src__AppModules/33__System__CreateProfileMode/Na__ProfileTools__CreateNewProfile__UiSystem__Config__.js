/* =============================================================================
   NA PROFILE TOOLS - CREATE NEW PROFILE - UI SYSTEM - CONFIG
   =============================================================================
   FILE       : Na__ProfileTools__CreateNewProfile__UiSystem__Config__.js
   NAMESPACE  : window.Na__ProfilePathTracer__Ui__Config
   PURPOSE    : UI configuration data — profile options, toggle definitions,
                path mode and source mode dropdown values, and defaults.
   ============================================================================= */
