(function () {
    ...
    var na_controls = [
        ...
        Object.assign(na_slider('double_door_left_opening_angle_deg', 'Left Opening Angle', 0, 180, 5, 90, 'Opening and Leaves'), { unit: '°' }),
        Object.assign(na_slider('double_door_right_opening_angle_deg', 'Right Opening Angle', 0, 180, 5, 90, 'Opening and Leaves'), { unit: '°' }),
    ...
    window.NA_EXT_DOUBLE_DOOR_CONFIG = na_controls;
    window.NA_DOUBLE_DOOR_CONFIG = na_controls;
    window.Na__ExtDouble__UiConfig = Object.freeze({
        na_controls: na_controls,
