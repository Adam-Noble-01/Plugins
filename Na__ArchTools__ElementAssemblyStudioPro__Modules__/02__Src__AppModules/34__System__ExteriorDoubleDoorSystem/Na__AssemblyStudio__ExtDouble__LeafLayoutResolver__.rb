...
# =============================================================================
# ELEMENT ASSEMBLY STUDIO PRO - EXTERIOR DOUBLE DOOR - LEAF LAYOUT RESOLVER
# =============================================================================
#
# FILE       : Na__AssemblyStudio__ExtDouble__LeafLayoutResolver__.rb
# NAMESPACE  : Na__AssemblyStudio::Na__ExteriorDoubleDoorSystem
# MODULE     : Na__LeafLayoutResolver
# AUTHOR     : Noble Architecture
# PURPOSE    : Resolve left and right leaf descriptors (position, hinge, swing,
#              dimensions) in the shape the shared ExtDoorCommon builders and
#              the AssemblyComposer consume.
#
# NAMING CONVENTION:
...
# -----------------------------------------------------------------------------
    ...
    # FUNCTION | Resolve Left and Right Leaf Descriptor Array
    # ------------------------------------------------------------
    # @param config [Hash] Door configuration
    # @return [Array<Hash>] Two-element frozen leaf array, or empty
...
# -----------------------------------------------------------------------------
    ...
    # HELPER FUNCTION | Build One Leaf Descriptor Hash (Left or Right)
    # ------------------------------------------------------------
    def self.na_build_leaf(config, dimensions, widths, side, panel_y)
        ...
        angle     = GeometryHelpers.na_number(config, "double_door_#{side}_opening_angle_deg", 90)
