...
# =============================================================================
# ELEMENT ASSEMBLY STUDIO PRO - EXTERIOR MULTIFOLD DOOR - PANEL LAYOUT RESOLVER
# =============================================================================
#
# FILE       : Na__AssemblyStudio__ExtFold__PanelLayoutResolver__.rb
# PURPOSE    : Maps bifold_door_* keys into ExtDoorCommon panel_config.
#              One shared config applies to every panel in the set.
#
...
module Na__PanelLayoutResolver
    ...
    def self.na_panel_config(config)
        ...
        composition = get.call('bifold_door_leaf_composition', nil)
        if composition.nil?
...

        {
            ...
            'profile' => get.call('bifold_door_panel_profile', 'RaisedBevelled'),
            'preset' => get.call('bifold_door_panel_preset', 'OnePanel'),
            'columns' => get.call('bifold_door_panel_columns', 1),
            'rows' => get.call('bifold_door_panel_rows', 1),
            'fielded_height_mm' => get.call('bifold_door_fielded_section_height_mm', 300),
            'mid_rail_width_mm' => get.call('bifold_door_mid_rail_width_mm', 120),
            'stile_width_mm' => get.call('bifold_door_stile_width_mm', 95),
            'top_rail_width_mm' => get.call('bifold_door_head_rail_mm', 95),
            'bottom_rail_width_mm' => get.call('bifold_door_base_rail_mm', 200),
            'panel_inset_mm' => get.call('bifold_door_panel_inset_mm', 25),
            'panel_depth_mm' => get.call('bifold_door_panel_depth_mm', 12),
            'panel_bevel_width_mm' => get.call('bifold_door_panel_bevel_width_mm', 18),
