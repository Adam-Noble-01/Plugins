...
# PURPOSE    : Drag state machine, plane inference, VCB routing and previews shared by Drawn tools
# CREATED    : 2026
#
# DESCRIPTION:
# - DrawnToolShared is mixed into every click-and-drag tool. Its methods have
#   full access to the host instance variables, all of which are created by
...
require_relative '../01__AppCore/Na__InsertPrimatives__AppCore__ModeSwitch__'

module Na__InsertPrimatives

    # @delegate: ../01__AppCore/Na__InsertPrimatives__AppCore__ModeSwitch__.rb
    ...
    module DrawnToolShared
        ...
        def na_drawn__print_activation_banner
            ...
            Na__InsertPrimatives.Na__Debug__Puts '----------------------------------------'
            Na__InsertPrimatives.Na__Debug__Puts "#{na_drawn__tool_title.upcase} ACTIVATED"
            Na__InsertPrimatives.Na__Debug__Puts "Snap grid: #{Na__InsertPrimatives.Na__DrawnSettings__GridStepLabel} voxel lattice"
            na_drawn__activation_hints.each { |hint| Na__InsertPrimatives.Na__Debug__Puts hint }
            Na__InsertPrimatives.Na__Debug__Puts '----------------------------------------'
        end
        # ---------------------------------------------------------------
