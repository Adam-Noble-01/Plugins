...
var IS_MAC = false; // reset by Ruby
...
function disable(){ 
	txt = setTXT();
	//alert(txt);
	sketchup.disable(txt);
  //cmd = 'skp:disable@' + txt;
	//window.location = cmd;
	if(IS_MAC == true){sleep(50);}
  setTimeout(() => {
    document.getElementById('selectLeft').scrollTop = 0;
  }, "50");
}
function load(){
	txt = setTXTX();
  ...
  setTimeout(() => {
    document.getElementById('selectLeft').scrollTop = 0;
    document.getElementById('selectRight').scrollTop = 0;
  }, "50");
}
function enable(){
	txt = setTXTX();
...
function changeplugins(){
  ...
  sketchup.changeplugins(p.replace(/[']/g, '"'));
...
function disableL(){
  ...
  if(EXTN == false){document.getElementById('btnC').disabled='disabled';}
  //setTimeout(() => {
    //document.getElementById('selectLeft').scrollTop = 0;
    //document.getElementById('selectRight').scrollTop = 0;
  //}, "50");
...
function enableLR(){
  ...
  if(! EXTN == true){document.getElementById('btnC').removeAttribute('disabled', 0);}
  //setTimeout(() => {
    //document.getElementById('selectLeft').scrollTop = 0;
    //document.getElementById('selectRight').scrollTop = 0;
  //}, "50");
...
function disableLR(){
	document.getElementById('btnL').disabled='disabled';
	document.getElementById('btnR').disabled='disabled';
  if(! EXTN == true){document.getElementById('btnC').disabled='disabled';}
  //setTimeout(() => {
    //document.getElementById('selectLeft').scrollTop = 0;
    //document.getElementById('selectRight').scrollTop = 0;
  //}, "50");
