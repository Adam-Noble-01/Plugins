...
var _subdivision_error = require('./subdivision_error.vue');

var _subdivision_error2 = _interopRequireDefault(_subdivision_error);
...
function boot(config) {
  ...
  var vm = new Vue({
    ...
    render: function render(h) {
      return h(_subdivision_error2.default);
    },
    data: {
...
},{"./modules/translator.js":2,"./modules/vue_su_error_handler.js":3,"./subdivision_error.vue":4,"voo-i18n":42}],2:[function(require,module,exports){
'use strict';
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_c('img',{attrs:{"src":"../../images/subdivide-24.png","width":"24","height":"24"}}),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.$tr('Failed to Subdivide')))])]),_vm._v(" "),_c('div',{attrs:{"id":"content"}},[_c('p',[_vm._v("\n      "+_vm._s(_vm.$tr("\n      Sorry! This mesh failed to subdivide. This is most likely due to the\n      generated faces being too small for what SketchUp can create.\n      "))+"\n    ")]),_vm._v(" "),_c('p',[_vm._v("\n      "+_vm._s(_vm.$tr("\n      Try decreasing the subdivision level or scale up the control mesh. For\n      more information check out the Help section.\n      "))+"\n    ")])]),_vm._v(" "),_c('div',{attrs:{"id":"footer"}},[_c('button',{on:{"click":_vm.help}},[_vm._v(_vm._s(_vm.$tr('Help')))]),_vm._v(" "),_c('button',{on:{"click":_vm.close}},[_vm._v(_vm._s(_vm.$tr('Close')))])])])}
