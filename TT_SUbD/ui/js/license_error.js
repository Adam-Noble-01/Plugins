...
var _license_error = require('./license_error.vue');

var _license_error2 = _interopRequireDefault(_license_error);
...
// TODO: Reuse code with subdivision_error.js.
// import Vue from 'vue'
...
function boot(config) {
  ...
  var vm = new Vue({
    ...
    render: function render(h) {
      return h(_license_error2.default, {
        props: {
          config: config.data
        }
      });
...
},{"./license_error.vue":2,"./modules/translator.js":3,"./modules/vue_su_error_handler.js":4,"voo-i18n":42}],2:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
  ...
  methods: {
    license: function license() {
      Sketchup.callback("LicenseErrorWindow.open_license_dialog");
    },
    help: function help() {
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_c('img',{attrs:{"src":"../../images/subdivide-24.png","width":"24","height":"24"}}),_vm._v(" "),_c('span',{attrs:{"id":"title"}},[(_vm.error.name == 'NotLicensedError')?_c('span',[_vm._v("\n        "+_vm._s(_vm.$tr('Not Licensed'))+"\n      ")]):_vm._e(),_vm._v(" "),(_vm.error.name == 'LicenseExpiredError')?_c('span',[_vm._v("\n        "+_vm._s(_vm.$tr('License Expired'))+"\n      ")]):_vm._e(),_vm._v(" "),(_vm.error.name == 'TrialLicenseExpiredError')?_c('span',[_vm._v("\n        "+_vm._s(_vm.$tr('Trial License Expired'))+"\n      ")]):_vm._e(),_vm._v(" "),(_vm.error.name == 'BetaBuildExpiredError')?_c('span',[_vm._v("\n        "+_vm._s(_vm.$tr('Beta Build Expired'))+"\n      ")]):_vm._e(),_vm._v(" "),(_vm.error.name == 'LicenseError')?_c('span',[_vm._v("\n        "+_vm._s(_vm.$tr('License Error'))+"\n      ")]):_vm._e()])]),_vm._v(" "),_c('div',{attrs:{"id":"content"}},[(_vm.error.name == 'NotLicensedError')?_c('div',[_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        SUbD is not activated. Please obtain a valid license.\n        "))+"\n      ")]),_vm._v(" "),_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        If you believe you see this message in error, then please contact for\n        support.\n        "))+"\n      ")])]):_vm._e(),_vm._v(" "),(_vm.error.name == 'LicenseExpiredError')?_c('div',[_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        Your SUbD license has expired. Please make sure you have a valid\n        license.\n        "))+"\n      ")])]):_vm._e(),_vm._v(" "),(_vm.error.name == 'TrialLicenseExpiredError')?_c('div',[_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        Your SUbD trial license has expired. Please purchase a full license in\n        order to continue using the product.\n        "))+"\n      ")])]):_vm._e(),_vm._v(" "),(_vm.error.name == 'BetaBuildExpiredError')?_c('div',[_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        Your SUbD beta build has expired.\n        "))+"\n      ")])]):_vm._e(),_vm._v(" "),(_vm.error.name == 'LicenseError')?_c('div',[_c('p',[_vm._v("\n        "+_vm._s(_vm.$tr("\n        There was an unexpected error obtaining your license. Please make sure\n        you have a working internet connection and valid license.\n        "))+"\n      ")]),_vm._v(" "),_c('p',[_vm._v("\n        "+_vm._s(_vm.error.message)+"\n      ")])]):_vm._e()]),_vm._v(" "),_c('div',{attrs:{"id":"footer"}},[_c('button',{on:{"click":_vm.help}},[_vm._v(_vm._s(_vm.$tr('Help')))]),_vm._v(" "),_c('button',{on:{"click":_vm.license}},[_vm._v(_vm._s(_vm.$tr('License…')))]),_vm._v(" "),_c('button',{on:{"click":_vm.close}},[_vm._v(_vm._s(_vm.$tr('Close')))])])])}
...
},{"babel-runtime/core-js/object/keys":5}]},{},[1])