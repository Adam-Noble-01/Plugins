...
},{"./modules/translator.js":6,"./modules/vue_su_error_handler.js":7,"./preferences.vue":8,"voo-i18n":46}],6:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  data: function data() {
    return {
      features: {
        high_dpi: sketchup_info().version < 17 && sketchup_info().version > 0
      },
...
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"container"},[_c('tt-option-header',[_vm._v(_vm._s(_vm.$tr('Modelling')))]),_vm._v(" "),_c('tt-option-checkbox',{model:{value:(_vm.options.relative_sharpness),callback:function ($$v) {_vm.$set(_vm.options, "relative_sharpness", $$v)},expression:"options.relative_sharpness"}},[_vm._v("\n      "+_vm._s(_vm.$tr('Relative Sharpness'))+"\n      "),_c('div',{attrs:{"slot":"description"},slot:"description"},[_vm._v("\n        "+_vm._s(_vm.$tr('Toggle to adjust creasing in a range of 0.0 to 1.0 relative to the current subdivision level.'))+"\n      ")])]),_vm._v(" "),_c('tt-option-checkbox',{model:{value:(_vm.options.fix_manifolds),callback:function ($$v) {_vm.$set(_vm.options, "fix_manifolds", $$v)},expression:"options.fix_manifolds"}},[_vm._v("\n      "+_vm._s(_vm.$tr('Fix Manifolds'))+"\n      "),_c('div',{attrs:{"slot":"description"},slot:"description"},[_vm._v("\n        "+_vm._s(_vm.$tr('Make SUbD check if a mesh is manifold before subdividing. Prompts to try to remove internal faces.'))+"\n      ")])]),_vm._v(" "),_c('hr',{staticClass:"hr-sm"}),_vm._v(" "),_c('tt-option-header',[_vm._v(_vm._s(_vm.$tr('Tools')))]),_vm._v(" "),_c('tt-option-checkbox',{model:{value:(_vm.options.replace_pushpull),callback:function ($$v) {_vm.$set(_vm.options, "replace_pushpull", $$v)},expression:"options.replace_pushpull"}},[_vm._v("\n      "+_vm._s(_vm.$tr('Replace Push/Pull Tool'))+"\n      "),_c('div',{attrs:{"slot":"description"},slot:"description"},[_vm._v("\n        "+_vm._s(_vm.$tr("Intercept and replace SketchUp's native Push/Pull tool with SUbD's custom tool designed to preserve quads better."))+"\n      ")])]),_vm._v(" "),_c('hr',{staticClass:"hr-sm"}),_vm._v(" "),_c('tt-option-header',[_vm._v(_vm._s(_vm.$tr('Display')))]),_vm._v(" "),_c('p',{staticClass:"note"},[_c('span',{staticClass:"glyphicon glyphicon-info-sign",attrs:{"aria-hidden":"true"}}),_vm._v(" "),_c('span',{staticClass:"localize"},[_vm._v("\n        "+_vm._s(_vm.$tr('Display options require restart of SketchUp for changes to take effect.'))+"\n      ")])]),_vm._v(" "),_c('tt-option-select',{attrs:{"label":"Language"},model:{value:(_vm.options.locale),callback:function ($$v) {_vm.$set(_vm.options, "locale", $$v)},expression:"options.locale"}},[_c('span',{attrs:{"slot":"label"},slot:"label"},[_vm._v(_vm._s(_vm.$tr('Language')))]),_vm._v(" "),_vm._l((_vm.locales),function(locale){return _c('option',{domProps:{"value":locale.code}},[_vm._v("\n        "+_vm._s(locale.metadata.language)+"\n      ")])}),_vm._v(" "),_c('p',{attrs:{"slot":"description"},slot:"description"},[_vm._v("\n        "+_vm._s(_vm.$tr('Author:'))+"\n        "),(_vm.current_language.metadata.contact.lastIndexOf('http', 0) === 0)?_c('a',{attrs:{"href":_vm.current_language.metadata.contact}},[_vm._v("\n          "+_vm._s(_vm.current_language.metadata.author)+"\n        ")]):_c('span',{attrs:{"title":_vm.current_language.metadata.contact}},[_vm._v("\n          "+_vm._s(_vm.current_language.metadata.author)+"\n        ")])])],2),_vm._v(" "),(_vm.features.high_dpi)?_c('tt-option-checkbox',{model:{value:(_vm.options.high_dpi),callback:function ($$v) {_vm.$set(_vm.options, "high_dpi", $$v)},expression:"options.high_dpi"}},[_vm._v("\n      "+_vm._s(_vm.$tr('High DPI'))+"\n      "),_c('div',{attrs:{"slot":"description"},slot:"description"},[_vm._v("\n        "+_vm._s(_vm.$tr('Doubles the size of viewport UI elements and dialogs.'))+"\n      ")])]):_vm._e()],1),_vm._v(" "),_c('div',{staticClass:"footer"},[_c('tt-button',{on:{"click":_vm.cancel}},[_vm._v(_vm._s(_vm.$tr('Cancel')))]),_vm._v(" "),_c('tt-button',{on:{"click":_vm.save}},[_vm._v(_vm._s(_vm.$tr('Save')))])],1)])}
__vue__options__.staticRenderFns = []

},{"./components/button.vue":1,"./components/option-checkbox.vue":2,"./components/option-header.vue":3,"./components/option-select.vue":4}],9:[function(require,module,exports){
"use strict";

module.exports = { "default": require("core-js/library/fn/object/keys"), __esModule: true };
},{"core-js/library/fn/object/keys":10}],10:[function(require,module,exports){
'use strict';

require('../../modules/es6.object.keys');
module.exports = require('../../modules/_core').Object.keys;
},{"../../modules/_core":15,"../../modules/es6.object.keys":44}],11:[function(require,module,exports){
'use strict';
...
},{"./_to-absolute-index":37,"./_to-iobject":39,"./_to-length":40}],14:[function(require,module,exports){
"use strict";
...
},{"./_core":15,"./_ctx":16,"./_global":23,"./_has":24,"./_hide":25}],22:[function(require,module,exports){
"use strict";
...
},{"./_descriptors":18,"./_object-dp":30,"./_property-desc":34}],26:[function(require,module,exports){
'use strict';
...
},{"./_an-object":12,"./_descriptors":18,"./_ie8-dom-define":26,"./_to-primitive":42}],31:[function(require,module,exports){
'use strict';
...
},{"./_array-includes":13,"./_has":24,"./_shared-key":35,"./_to-iobject":39}],32:[function(require,module,exports){
'use strict';
...
},{"./_enum-bug-keys":20,"./_object-keys-internal":31}],33:[function(require,module,exports){
'use strict';
...
},{"./_core":15,"./_export":21,"./_fails":22}],34:[function(require,module,exports){
"use strict";
...
},{"./_core":15,"./_global":23,"./_library":29}],37:[function(require,module,exports){
'use strict';
...
},{"./_defined":17,"./_iobject":27}],40:[function(require,module,exports){
'use strict';
...
},{"./_defined":17}],42:[function(require,module,exports){
'use strict';
...
},{"./_is-object":28}],43:[function(require,module,exports){
'use strict';
...
},{"./_object-keys":32,"./_object-sap":33,"./_to-object":41}],45:[function(require,module,exports){
'use strict';
...
},{"./format":45,"./translations":47}],47:[function(require,module,exports){
(function (global){
'use strict';
...
},{"babel-runtime/core-js/object/keys":9}]},{},[5])